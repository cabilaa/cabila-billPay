...
fun BungaScreen (navController: NavHostController)  {
    ...
    Scaffold(
        ...
        BungaContent(showList, Modifier.padding(innerPadding), navController)
    }
}
@Composable
fun BungaContent(showList: Boolean, modifier: Modifier = Modifier, navController: NavHostController) {
...
@Composable
fun GridItem(pinjaman: Pinjaman, onClick: () -> Unit) {
    Card(
